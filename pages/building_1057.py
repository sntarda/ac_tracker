...
# Function to display the Building 1057 page
def building_1057_page():
    st.title("Building 1057")

    units = load_units('data/units.csv')
    building_units = units[units['Facility'] == '1057 S Sherman']

    if building_units.empty:
        st.write("No units found for Building 1057.")
    else:
